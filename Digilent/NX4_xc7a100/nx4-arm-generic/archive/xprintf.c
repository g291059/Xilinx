 ...
 * function without the overhead most run-time libraries involve. Usually the printf
 * brings in many kilobytes of code and that is unacceptable in most embedded systems.*/
...
static s32 getnum( char ** linep)
{
 ...
 /* This routine operates just like a printf/sprintf  routine. It outputs a set of data under the
 * control of a formatting string. Not all of the standard C format control are supported. The ones
 * provided are primarily those needed for embedded systems work. Primarily the floating point
 * routines are omitted. Other formats could be added easily by following the examples shown for
 * the supported formats. */

/* void esp_printf( const func_ptr f_ptr,const charptr ctrl1, ...) */
