...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_i_1 [get_bd_ports clk_i] [get_bd_pins sync_t1_0/clk_pxl]
  connect_bd_net -net sync_t1_0_B [get_bd_ports vga_blue_o] [get_bd_pins sync_t1_0/B]
  connect_bd_net -net sync_t1_0_G [get_bd_ports vga_green_o] [get_bd_pins sync_t1_0/G]
  connect_bd_net -net sync_t1_0_R [get_bd_ports vga_red_o] [get_bd_pins sync_t1_0/R]
  connect_bd_net -net sync_t1_0_hsync [get_bd_ports vga_hs_o] [get_bd_pins sync_t1_0/hsync]
  connect_bd_net -net sync_t1_0_vsync [get_bd_ports vga_vs_o] [get_bd_pins sync_t1_0/vsync]
