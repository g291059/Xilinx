...
module design_1_ramctrl_0_0(clk, rst, arg_1, arg_2, dia, addra, wea)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,arg_1[2:0],arg_2[2:0],dia[7:0],addra[9:0],wea" */;
  input clk;
  input rst;
  input [2:0]arg_1;
  input [2:0]arg_2;
