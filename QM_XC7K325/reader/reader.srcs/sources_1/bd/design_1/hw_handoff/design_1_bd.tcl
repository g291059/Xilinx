...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net p2s_0_csx [get_bd_ports J12_8] [get_bd_pins p2s_0/csx]
  connect_bd_net -net p2s_0_dcx [get_bd_ports J13_1] [get_bd_pins p2s_0/dcx]
  connect_bd_net -net p2s_0_ready [get_bd_pins p2s_0/ready] [get_bd_pins sync_t1_0/ready]
  connect_bd_net -net p2s_0_resx [get_bd_ports J12_7] [get_bd_pins p2s_0/resx]
  connect_bd_net -net p2s_0_scl [get_bd_ports J12_5] [get_bd_pins p2s_0/scl]
  connect_bd_net -net p2s_0_sda [get_bd_ports J12_6] [get_bd_pins p2s_0/sda]
  ...
  connect_bd_net -net tm1637_standalone_0_scl [get_bd_ports J12_1] [get_bd_pins tm1637_standalone_0/scl]
  connect_bd_net -net tm1637_standalone_0_sda [get_bd_ports J12_2] [get_bd_pins tm1637_standalone_0/sda]
  connect_bd_net -net tm1637_standalone_1_scl [get_bd_ports J12_3] [get_bd_pins tm1637_standalone_1/scl]
  connect_bd_net -net tm1637_standalone_1_sda [get_bd_ports J12_4] [get_bd_pins tm1637_standalone_1/sda]
