...
#-----   keys on CORE board -----
#set_property -dict { PACKAGE_PIN P6     IOSTANDARD LVCMOS18   } [get_ports  key_1  ]
set_property -dict { PACKAGE_PIN AB26   IOSTANDARD LVCMOS18   } [get_ports  key_2  ]
set_property -dict { PACKAGE_PIN AC26   IOSTANDARD LVCMOS18   } [get_ports  key_3  ]

#-----   leds on CORE board (not connected) -----
set_property -dict { PACKAGE_PIN R26     IOSTANDARD LVCMOS18   } [get_ports  led2  ]
set_property -dict { PACKAGE_PIN P26     IOSTANDARD LVCMOS18   } [get_ports  led3  ]

#-----   leds on Daughter board -----
set_property -dict { PACKAGE_PIN B14    IOSTANDARD LVCMOS33   } [get_ports  led_5  ]
set_property -dict { PACKAGE_PIN C14    IOSTANDARD LVCMOS33   } [get_ports  led_4  ]
set_property -dict { PACKAGE_PIN E25    IOSTANDARD LVCMOS33   } [get_ports  led_3  ]

#-----   keys on CORE board -----
set_property -dict { PACKAGE_PIN AD18   IOSTANDARD LVCMOS18   } [get_ports  key_4  ]
set_property -dict { PACKAGE_PIN AF19   IOSTANDARD LVCMOS18   } [get_ports  key_5  ]
set_property -dict { PACKAGE_PIN AF20   IOSTANDARD LVCMOS18   } [get_ports  key_6  ]
...
set_property -dict { PACKAGE_PIN AB25   IOSTANDARD LVCMOS18   } [get_ports  switch_7  ]
set_property -dict { PACKAGE_PIN AA25   IOSTANDARD LVCMOS18   } [get_ports  switch_6  ]
set_property -dict { PACKAGE_PIN AC24   IOSTANDARD LVCMOS18   } [get_ports  switch_5  ]
set_property -dict { PACKAGE_PIN AC23   IOSTANDARD LVCMOS18   } [get_ports  switch_4  ]
set_property -dict { PACKAGE_PIN AA24   IOSTANDARD LVCMOS18   } [get_ports  switch_3  ]
set_property -dict { PACKAGE_PIN Y23    IOSTANDARD LVCMOS18   } [get_ports  switch_2  ]
set_property -dict { PACKAGE_PIN AA22   IOSTANDARD LVCMOS18   } [get_ports  switch_1  ]
set_property -dict { PACKAGE_PIN Y22    IOSTANDARD LVCMOS18   } [get_ports  switch_0  ]
...
#-----   vga -----
set_property -dict { PACKAGE_PIN B19 IOSTANDARD LVCMOS33   } [get_ports {vga_r[4]}]
set_property -dict { PACKAGE_PIN A18 IOSTANDARD LVCMOS33   } [get_ports {vga_r[3]}]
set_property -dict { PACKAGE_PIN A20 IOSTANDARD LVCMOS33   } [get_ports {vga_r[2]}]
set_property -dict { PACKAGE_PIN C19 IOSTANDARD LVCMOS33   } [get_ports {vga_r[1]}]
set_property -dict { PACKAGE_PIN B20 IOSTANDARD LVCMOS33   } [get_ports {vga_r[0]}]
set_property -dict { PACKAGE_PIN D18 IOSTANDARD LVCMOS33   } [get_ports {vga_g[5]}]
set_property -dict { PACKAGE_PIN C13 IOSTANDARD LVCMOS33   } [get_ports {vga_g[4]}]
set_property -dict { PACKAGE_PIN C18 IOSTANDARD LVCMOS33   } [get_ports {vga_g[3]}]
set_property -dict { PACKAGE_PIN E18 IOSTANDARD LVCMOS33   } [get_ports {vga_g[2]}]
set_property -dict { PACKAGE_PIN C17 IOSTANDARD LVCMOS33   } [get_ports {vga_g[1]}]
set_property -dict { PACKAGE_PIN A19 IOSTANDARD LVCMOS33   } [get_ports {vga_g[0]}]
set_property -dict { PACKAGE_PIN A13 IOSTANDARD LVCMOS33   } [get_ports {vga_b[4]}]
set_property -dict { PACKAGE_PIN A12 IOSTANDARD LVCMOS33   } [get_ports {vga_b[3]}]
set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33   } [get_ports {vga_b[2]}]
set_property -dict { PACKAGE_PIN D13 IOSTANDARD LVCMOS33   } [get_ports {vga_b[1]}]
set_property -dict { PACKAGE_PIN A14 IOSTANDARD LVCMOS33   } [get_ports {vga_b[0]}]
set_property -dict { PACKAGE_PIN C12 IOSTANDARD LVCMOS33   } [get_ports vga_hs]
set_property -dict { PACKAGE_PIN C11 IOSTANDARD LVCMOS33   } [get_ports vga_vs]
